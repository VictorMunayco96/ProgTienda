...
CREATE TABLE IF NOT EXISTS `DBTienda`.`Cliente` (
  ...
  `TipoDocumento` BIGINT NULL COMMENT '',
  `NumDocumento` BIGINT NULL COMMENT '',
  `Nombres` VARCHAR(120) NULL COMMENT '',
  `Apellidos` VARCHAR(80) NULL COMMENT '',
  `FecNac` DATE NULL COMMENT '',
  `NumCel` VARCHAR(10) NULL COMMENT '',
  `Correo` VARCHAR(80) NULL COMMENT '',
  `Estado` TINYINT NULL COMMENT '',
  `Direccion` VARCHAR(60) NULL COMMENT '',
  `IdUsuario` INT NOT NULL COMMENT '',
  `IdSucursal` INT NOT NULL COMMENT '',
  PRIMARY KEY (`IdCliente`)  COMMENT '',
  INDEX `fk_Cliente_Usuario1_idx` (`IdUsuario` ASC)  COMMENT '',
  INDEX `fk_Cliente_Sucursal1_idx` (`IdSucursal` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `DBTienda`.`Venta` (
  ...
  `TipoComprobante` VARCHAR(45) NULL COMMENT '',
  `SerieCompro` INT NULL COMMENT '',
  `NumCompro` INT NULL COMMENT '',
  `Fecha` DATETIME NULL COMMENT '',
  `EstadoVenta` TINYINT NULL COMMENT '',
  `TotalVenta` DECIMAL(7,4) NULL COMMENT '',
  `Impuesto` DECIMAL(7,4) NULL COMMENT '',
  `Estado` TINYINT NULL COMMENT '',
  `IdUsuario` INT NOT NULL COMMENT '',
  ...
  INDEX `fk_Venta_Usuario1_idx` (`IdUsuario` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `DBTienda`.`IngresoTienda` (
  ...
  `Estado` TINYINT NULL COMMENT '',
  `EstadoEnvio` TINYINT NULL COMMENT '',
  `IdDetalleCompra` INT NOT NULL COMMENT '',
  `FechaReg` DATETIME NULL COMMENT '',
  `FechaRecepcion` DATETIME NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `DBTienda`.`DetalleVenta` (
  ...
  `IdIngresoTienda` INT NOT NULL COMMENT '',
  `Cantidad` DECIMAL(7,2) NULL COMMENT '',
  `Precio` DECIMAL(7,2) NULL COMMENT '',
  PRIMARY KEY (`IdDetalleVenta`)  COMMENT '',
  INDEX `fk_DetalleVenta_Venta1_idx` (`IdVenta` ASC)  COMMENT '',
  INDEX `fk_DetalleVenta_IngresoTienda1_idx` (`IdIngresoTienda` ASC)  COMMENT '',
  CONSTRAINT `fk_DetalleVenta_Venta1`
    FOREIGN KEY (`IdVenta`)
    REFERENCES `DBTienda`.`Venta` (`IdVenta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DetalleVenta_IngresoTienda1`
    FOREIGN KEY (`IdIngresoTienda`)
    REFERENCES `DBTienda`.`IngresoTienda` (`IdIngresoTienda`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
